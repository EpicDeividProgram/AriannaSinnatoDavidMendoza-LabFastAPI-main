...
Revision ID: fa05aed7ec93
Revises: 0be0e5910936
Create Date: 2024-06-27 22:33:13.835952
...
revision: str = 'fa05aed7ec93'
down_revision: Union[str, None] = '0be0e5910936'
...
def downgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['estado_cotizacion_id'], ['estados_cotizacion.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
