...
def crear_caracteristica(caracteristica: schemas.Caracteristica_a_Crear, db: Session = Depends(get_db), info=Depends(auth_handler.auth_wrapper)):
...
def modificar_caracteristica(id : int, caracteristica: schemas.Caracteristica_a_Crear, db: Session = Depends(get_db), info=Depends(auth_handler.auth_wrapper)): 
